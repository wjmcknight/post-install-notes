...
```console
sudo apt install chromium geary filezilla transmission-gtk
```

### Multimedia

```console
sudo apt install audacity cheese handbrake-gtk sound-juicer beets ffmpeg flac lame mpg123 mpv normalize-audio eyed3 yt-dlp gstreamer1.0-vaapi mpd mpc ncmpcpp 
```
