# Void Linux 20250202 Post-Install Notes
...
```console
sudo xbps-install vulkan-loader mesa-vulkan-radeon mesa-vaapi mesa-vdpau htop nano nmap ncurses-term memtest86+ cronie xtools xdg-desktop-portal-gtk exfatprogs plocate gamin zsh vim gvim bluez blueman cpufrequtils haveged uptimed git base-devel python3-devel ruby-devel python3-pip ruby zola argyllcms xrdb galculator-gtk3 xfce4-places-plugin xfce4-whiskermenu-plugin conky faba-icon-theme papirus-icon-theme greybird-themes
```
...
```console
sudo xbps-install asunder audacity pragha guvcview handbrake xfburn beets python3-Flask mpg123 mpg123-pulseaudio mpv yt-dlp gstreamer-vaapi cmus cmus-faad cmus-ffmpeg cmus-flac cmus-pulseaudio eyeD3 libspa-bluetooth
```
